...
def get_total_stock(item_code, company=None, posting_date=None, posting_time=None):
    """Return total stock for an item across all warehouses for the given company/time slice."""
